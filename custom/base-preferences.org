...
* [[https://www.emacswiki.org/emacs/FlySpell#toc7][Spell checking]]
  ...
  For performance concerns, setting 'flyspell-issue-message-flag' to nil will stop fly spell from
  printing message for every word when checking the entire buffer which can cause an enormous slowdown.
  #+BEGIN_SRC emacs-lisp
